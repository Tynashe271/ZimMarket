...
export default function RegisterBusinessPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      const session = await api.register({ phone, email: email || undefined, password, accountType: 'BUSINESS' });

...
import { BusinessDetails, PrivacyPolicyContent, RefundsContent, TermsContent } from './legal';
...
type PageName = 'home' | 'marketplace' | 'services' | 'businesses' | 'about' | 'privacy' | 'terms' | 'refunds';

const legalBanners: Partial<Record<PageName, { title: string; intro: string }>> = {
  privacy: { title: 'Privacy policy', intro: 'How ZimMarket collects, uses and protects your personal data.' },
  terms: { title: 'Terms of service', intro: 'The rules that govern using ZimMarket as a customer or a business.' },
  refunds: { title: 'Refund policy', intro: 'When and how refunds work for orders placed through ZimMarket.' },
};
...
export function App({ page = 'home' }: { page?: PageName }) {
  ...
  return <>
    ...
    <main id="top">
      ...
      {page === 'privacy' && <PrivacyPolicyContent/>}
    ...
    <footer><div className="footer-top"><a className="brand" href="/"><span className="brand-mark">Z</span><span>ZimMarket</span></a><p>Zimbabwe's marketplace for local products, services and businesses.</p><div><a href="/marketplace">Marketplace</a><a href="/services">Services</a><a href="/businesses">Businesses</a><a href="/about">About</a></div><div><a href="/terms">Terms</a><a href="/privacy">Privacy</a><a href="/refunds">Refunds</a></div></div><BusinessDetails/><small>© 2026 ZimMarket. Made with care in Zimbabwe.</small></footer>
    <Assistant />

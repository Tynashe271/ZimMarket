...
@Controller() export class MarketplaceController {
  ...
  @Get('public/ads') ads() { return this.service.publicAds(); }
  ...
  @Get('conversations') @UseGuards(JwtAuthGuard) conversations(@CurrentUser() u: AuthUser) { return this.service.conversations(u.userId, u.accountType); }

...
describe('MarketplaceService', () => {
  it('blocks staff without a marketing-eligible role from creating an advertisement', async () => {
    ...
    const service = new MarketplaceService({ businessMember: { findUnique } } as never, {} as never, { require } as never, {} as never);
  ...
  it('refuses to advertise while business compliance is incomplete', async () => {
    ...
    const service = new MarketplaceService(prisma as never, {} as never, { require: jest.fn() } as never, {} as never);
  ...
  it('rejects a non-customer account from opening a storefront conversation', async () => {
    const service = new MarketplaceService({} as never, {} as never, {} as never, {} as never);
  ...
  it('rejects an empty message after trimming whitespace', async () => {
    ...
    const service = new MarketplaceService({ conversation: { findFirst } } as never, {} as never, {} as never, {} as never);
  ...
  it('rejects a document upload that fails the malware scan', async () => {
    ...
    const service = new MarketplaceService({ document: { create } } as never, {} as never, {} as never, providers as never);
